...
but do not stop the import.`,
  ...
  shipstation-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  shipstation-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | shipstation-pp-cli import <resource> --input -`,
